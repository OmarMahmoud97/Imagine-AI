...
exports.SpeechTranslationServiceClient = void 0;
 ...
 */
const gapicConfig = require("./speech_translation_service_client_config.json");
...
class SpeechTranslationServiceClient {
     ...
     *     const client = new SpeechTranslationServiceClient({fallback: 'rest'}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.stream = {
            streamingTranslateSpeech: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.BIDI_STREAMING, opts.fallback === 'rest'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.mediatranslation.v1beta1.SpeechTranslationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.speechTranslationServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.mediatranslation.v1beta1.SpeechTranslationService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.mediatranslation.v1beta1
                    .SpeechTranslationService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of speechTranslationServiceStubMethods) {
            const callPromise = this.speechTranslationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
...
exports.SpeechTranslationServiceClient = SpeechTranslationServiceClient;
//# sourceMappingURL=speech_translation_service_client.js.map